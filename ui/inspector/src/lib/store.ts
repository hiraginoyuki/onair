...
export const columns: Column[] = [
  ...
  { key: "status", label: "status", defaultWidth: 68, minWidth: 56, maxWidth: 92, align: "right" },
  ...
  { key: "exposed", label: "exposed", defaultWidth: 76, minWidth: 68, maxWidth: 96, align: "right" }
];
